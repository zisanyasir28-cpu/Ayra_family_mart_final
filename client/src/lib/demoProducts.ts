...
// Cloudinary optimized URL builder (background trim + enhance + best quality + WebP)
...
export const demoProducts: ApiProduct[] = [
  ...
  // ── Personal Care (Cloudinary) ─────────────────────────────────────────────

  p({
    id: 'pc-hair-oil', name: 'Aromatic Herbal Hair Oil', slug: 'aromatic-herbal-hair-oil',
    desc: 'A blend of 7 Ayurvedic herbs — amla, bhringraj, neem & sesame — in a light carrier oil. Strengthens roots, reduces breakage, and leaves hair with a healthy shine. Ideal for pre-wash massage; apply warm for best absorption.',
  ...
  p({
    ...
    desc: 'Fast-absorbing, non-greasy formula with shea butter, glycerin, and ceramides. Locks in 48-hour moisture even in Bangladesh\'s humid climate. Leaves skin silky-smooth from first use. Fragrance-free option, safe for all skin types.',
  ...
  p({
    ...
    desc: 'Dual-action day cream with SPF20 sun protection and niacinamide brightening complex. Gradually fades pigmentation, suntan, and dark patches while defending against further UV damage. Lightweight, non-sticky texture suitable for Bangladesh\'s humid heat.',
  ...
  p({
    ...
    desc: 'Cooling caffeine gel that deflates under-eye puffiness within 10 minutes of application. Vitamin K and peptide complex target dark circles at the source. Patented micro-needle free formula penetrates the delicate eye zone without irritation.',
  ...
  p({
    ...
    desc: 'Ancient 16-herb Ayurvedic formulation in a sesame oil base. Saffron, sandalwood, and lotus extracts restore natural radiance, reduce blemishes, and improve skin elasticity. 3–4 drops massaged nightly replace multiple serums and moisturisers.',
  ...
  p({
    ...
    desc: '25% urea concentration softens severely cracked heels and calluses overnight. Shea butter and allantoin provide deep, long-lasting moisture to neglected dry feet. Thick, non-greasy formula that absorbs quickly — wear socks after for best results.',
  ...
  p({
    ...
    desc: 'Set of 3 tinted balms in Berry, Coral, and Rose Nude. SPF20 sun protection, castor oil base for plump hydration, and buildable sheer colour. Tastes of vanilla, feels like bare lips — all day comfort without reapplying every hour.',
  ...
  p({
    ...
    desc: 'Dual-action kojic acid + glutathione soap that inhibits melanin production at the source. 60-second lather contact time is enough to start reversing tanning, dark elbows, knees, and uneven complexion. One bar lasts 4–6 weeks with daily use.',
  ...
  p({
    ...
    desc: 'Whipped, velvety body butter with real shea, mango butter, and rose hip seed oil. Sinks in luxuriously without greasiness. Repairs extremely dry skin, stretch marks, and scars over time. A little goes a long way — one jar lasts 2+ months.',
  ...
  p({
    ...
    desc: 'High-potency vitamin E (tocopherol) serum with rosehip oil and squalane. Works overnight to repair UV and environmental damage, soften fine lines, and restore the lipid barrier. Ideal for mature, stressed, or post-acne skin in need of recovery.',
