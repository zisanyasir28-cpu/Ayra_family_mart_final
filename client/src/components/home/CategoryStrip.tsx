...
const META: Record<string, {
  ...
  dairy:           { bangla: 'দুধ ও ডিম',         display: 'Dairy & Eggs',      Icon: Milk,      tint: 'text-cream',   chipGrad: 'from-cream/28 to-bg/85',     chipRing: 'ring-cream/40',   bgFrom: 'from-cream/26 via-cream/12'  },
  ...
  snacks:          { bangla: 'স্ন্যাকস',          display: 'Snacks & Munchies', Icon: Cookie,    tint: 'text-coral',   chipGrad: 'from-coral/35 to-bg/85',     chipRing: 'ring-coral/40',   bgFrom: 'from-coral/28 via-saffron/12'},
  ...
  household:       { bangla: 'হাউসহোল্ড কেয়ার', display: 'Household Care',    Icon: Droplets,  tint: 'text-plum',    chipGrad: 'from-plum/35 to-bg/85',      chipRing: 'ring-plum/40',    bgFrom: 'from-plum/30 via-plum/14'   },
  'personal-care': { bangla: 'পার্সোনাল কেয়ার', display: 'Personal Care',     Icon: Sparkles,  tint: 'text-blush',   chipGrad: 'from-blush/35 to-bg/85',     chipRing: 'ring-blush/40',   bgFrom: 'from-blush/28 via-blush/12' },
  meat:            { bangla: 'মাংস ও পোল্ট্রি',  display: 'Meat & Poultry',    Icon: Beef,      tint: 'text-coral',   chipGrad: 'from-coral/33 to-bg/85',     chipRing: 'ring-coral/40',   bgFrom: 'from-coral/26 via-coral/12' },
