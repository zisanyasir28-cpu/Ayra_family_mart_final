      ...
      <div className="container">
        ...
        >
          ...
          <motion.div
            ...
            className="invert-card glass-shine relative overflow-hidden rounded-3xl border border-saffron/20 bg-gradient-to-br from-saffron/15 via-surface to-surface p-5 shadow-[0_0_12px_-3px_hsl(var(--saffron)/0.45),inset_0_0_0_1px_hsl(var(--saffron)/0.25)]"
          >
          ...
          <motion.div
            variants={cardVariants}
            className="invert-card glass-shine relative overflow-hidden rounded-3xl border border-sage/20 bg-gradient-to-br from-sage/15 via-surface to-surface p-5 shadow-[0_0_12px_-3px_hsl(var(--sage)/0.35),inset_0_0_0_1px_hsl(var(--sage)/0.2)]"
          >
          ...
          <motion.div
            variants={cardVariants}
            className="invert-card glass-shine relative overflow-hidden rounded-3xl border border-coral/20 bg-gradient-to-br from-coral/15 via-surface to-surface p-5 shadow-[0_0_12px_-3px_hsl(var(--coral)/0.35),inset_0_0_0_1px_hsl(var(--coral)/0.2)]"
          >
          ...
          <motion.div
            variants={cardVariants}
            className="invert-card glass-shine relative overflow-hidden rounded-3xl border border-plum/20 bg-gradient-to-br from-plum/15 via-surface to-surface p-5 shadow-[0_0_12px_-3px_hsl(var(--plum)/0.35),inset_0_0_0_1px_hsl(var(--plum)/0.2)]"
          >
