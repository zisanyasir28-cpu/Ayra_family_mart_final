      ...
      <div className="container">
        ...
        >
          ...
          <motion.div
            ...
            className="invert-card glass-shine relative overflow-hidden rounded-3xl border border-saffron/20 bg-gradient-to-br from-saffron/20 via-surface-dark to-surface-dark p-5 shadow-[0_0_12px_-3px_hsl(var(--saffron)/0.45),inset_0_0_0_1px_hsl(var(--saffron)/0.25)]"
          >
            ...
            <p className="mt-1 text-xs text-dark-fg/50">Limited time offers — ending in</p>
            ...
            <Link
              ...
              className="group mt-5 inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-[0.14em] text-saffron transition hover:text-dark-fg"
            >
              View All Deals
          ...
          <motion.div
            variants={cardVariants}
            className="invert-card glass-shine relative overflow-hidden rounded-3xl border border-sage/20 bg-gradient-to-br from-sage/20 via-surface-dark to-surface-dark p-5 shadow-[0_0_12px_-3px_hsl(var(--sage)/0.35),inset_0_0_0_1px_hsl(var(--sage)/0.2)]"
          >
            ...
            <p className="mt-4 font-display text-2xl font-black leading-tight text-dark-fg">
              On orders<br />
              <span className="text-sage">over ৳1,500</span>
            </p>

            <p className="mt-2 text-xs text-dark-fg/50">
              No hidden fees. No minimum fuss.
            </p>
            <p className="mt-1 font-bangla text-xs text-dark-fg/40">
              বিনামূল্যে ডেলিভারি
            </p>
          ...
          >
            ...
            <div className="mt-4 rounded-2xl bg-gradient-to-br from-coral/30 via-saffron/15 to-plum/20 p-3">
              ...
              <p className="font-display text-xl font-black text-dark-fg">Extra 15% Off</p>
          ...
          >
            ...
            <p className="mt-1 font-bangla text-xs text-dark-fg/40">আপনার পয়েন্ট</p>

            <div className="mt-3 flex items-baseline gap-2">
              <span className="font-display text-4xl font-black text-dark-fg tabular-nums">
                860
              </span>
              <span className="font-display text-sm text-dark-fg/55">Points</span>
            </div>
